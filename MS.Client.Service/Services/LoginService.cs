namespace MS.Client.Service
{
    public class LoginService : ILoginService
    {
        ...
        public async Task<FurApiResponse<LoginDto>> Login(LoginInput input)
        {
            ...
            var model = await $"api/{serviceName}/login"
                ...
                }).SetClient(ApiName).SetBody(input).PostAsAsync<FurApiResponse<LoginDto>>();
            return model;
        }

        public async Task<FurApiResponse<bool>> Resgiter(UserDto user)
        {
